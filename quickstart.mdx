...
<Steps>
  <Step title="Create your merchant account">
    Sign in to the [merchant dashboard](https://pay.macleodtechnologies.org)
  ...
  <Step title="Create a payment intent">
    ```bash
    curl -X POST https://api.macleodtechnologies.org/v1/gateway/api/payment-intents \
  ...
  <Step title="Send your customer to checkout">
    Redirect to `https://pay.macleodtechnologies.org/pay/<intent-id>` — they
